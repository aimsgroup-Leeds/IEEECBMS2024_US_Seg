...
class ExtRandomDiagonalFlip(object):
    """Randomly flip the given PIL Image along the diagonal with a given probability.
    ...
    def __call__(self, img, lbl):
        ...
        Returns:
            PIL Image, PIL Image: Randomly flipped image and label.
        """
        if random.random() < self.p:
            return F.rotate(img, angle=90), F.rotate(lbl, angle=90)
        return img, lbl
