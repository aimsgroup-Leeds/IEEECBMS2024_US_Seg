...
def get_argparser():
    ...
    parser.add_argument("--dataset", type=str, default='BUSI',
                        choices=['BUSI', 'US_Nerve'], help='Name of dataset')
...
def main():
    ...
    if opts.lr_policy == 'poly':
        scheduler = utils.PolyLR(optimizer, opts.total_itrs, power=0.9, min_lr= opts.lr_min)
    ...
    denorm = utils.Denormalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])  # denormalization for original images
    ...
    while True:  # cur_itrs < opts.total_itrs:
        ...
        for (images, labels) in train_loader:
            ...
            if cur_itrs % opts.val_interval == 0:
                ...
                # writer.add_scalar('Loss/val', val_loss, cur_epochs, cur_itrs)
                ...
                # elif val_loss >= (best_val_loss + stopping_threshold * best_val_loss):
